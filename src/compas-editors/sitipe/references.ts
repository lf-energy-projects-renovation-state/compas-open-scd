// TODO: Copy from plugins > src > wizards > foundation > references.ts
// Importing it from plugins package causes the tests to fail because 'wizard-textfield' is defined twice as a webcomponent
